                ...
                <nav class="px-4 py-4">
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="/domains" class="flex items-center gap-3 px-4 py-3 rounded-lg {{if eq .CurrentPath "/domains"}}bg-brand-600 text-white{{else}}text-gray-300 hover:bg-white/5 hover:text-white{{end}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
